...
def setup_logger( targetdir = ".",
                  filename = "get_dgroup_types.log",
                  logger_name = 'get_dgroup_types',
                  debugflag = 0 ):
    # Set up main logger
...
def main_process( output = None,
    ...
    work_dir = os.path.join( main_config["directory"], "BYTYPE" )
    ...
    results = {}
    # key object type or per object Id? TODO TODO TODO TODO ->
    #     group dictionary {
    #         "types" : subgroup types not including 
    # }
    # Other possibilities:
    #     Do we need other metrics like sizes? Or allocation sites?
    print "DONE: DEBUG"
    exit(1)
...
def create_parser():
    ...
    parser.add_argument( "--logfile",
                         ...
                         action = "store" )
    parser.set_defaults( logfile = "get_dgroup_types.log",
                         debugflag = False,
                         lastedgeflag = False,
                         benchmark = "_ALL_",
                         config = None )
...
def process_config( args ):
    ...
    # TODO: Reuse the same worklist for hosts?
...
def main():
    ...
    # TODO etanalyze_config = configdict["etanalyze"]
