...
def setup_logger( targetdir = ".",
                  filename = "verify_traces.log",
                  logger_name = 'verify_traces',
                  debugflag = 0 ):
    # Set up main logger
...
def create_parser():
    ...
    # TODO: parser.add_argument( "output", help = "Target output filename." )
    ...
    parser.add_argument( "--logfile",
                         ...
                         action = "store" )
    parser.set_defaults( logfile = "verify_traces.log",
                         debugflag = False,
                         benchmark = "_ALL_",
                         config = None )
    return parser
...
def main():
    ...
    assert( args.config != None )
    # Process basic_merge_summary.ini
    result = process_config( args )
    global_config = result["global"]
    host_config = process_host_config( result["host"] )
    # Process simulator.ini
    sim_result = process_sim_config( args )
    print "================================================================================"
    pp.pprint(sim_result)
    print "================================================================================"
    benchmarks = sim_result["benchmarks"]
    # TODO: Should there be a worklist? NAH.
