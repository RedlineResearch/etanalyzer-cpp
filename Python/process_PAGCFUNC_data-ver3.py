...
def setup_logger( targetdir = ".",
                  filename = "process_PAGCFUNC_data-ver3.log",
                  logger_name = 'process_PAGCFUNC_data-ver3',
                  debugflag = 0 ):
    # Set up main logger
...
def main_process( benchmark = None,
    ...
    if len(over_soln) > 0:
        ...
        pp.pprint(over_soln)
    print "================================================================================"
    print "process_PAGCFUNC_data-ver3.py - DONE."
    print "================================================================================"
    exit(100)
...
def create_parser():
    ...
    parser.add_argument( "--logfile",
                         ...
                         action = "store" )
    parser.set_defaults( logfile = "process_PAGCFUNC_data-ver3.log",
                         debugflag = False,
                         benchmark = None,
                         target = None,
                         epsilon = 0 )
