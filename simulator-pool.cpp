...
unsigned int read_trace_file( FILE *f,
                              ofstream &eifile,
                              MemoryPool<Object, 1310720> &objpool )
{
    // eifile is the edge_info_file
    Tokenizer tokenizer(f);

    // Memory pool allocator for Objects
            ...
            case 'V':
                {
                    ...
                    // } // END DEBUG
                    // TODO: obj = Heap.allocate( tokenizer.getInt(1),    // id
                    // TODO:                      tokenizer.getInt(2),    // size
                    // TODO:                      tokenizer.getChar(0),   // kind of alloc
                    // TODO:                      tokenizer.getString(3), // type
                    // TODO:                      as,      // AllocSite pointer
                    // TODO:                      els,     // length IF applicable
                    // TODO:                      thread,  // thread Id
                    // TODO:                      Exec.NowUp() ); // Current time
                    obj = objpool.newElement( tokenizer.getInt(1),    // id
...
int main(int argc, char* argv[])
{
    ...
    MemoryPool<Object, 1310720> objpool( basedir );
    char tmpbuf[1310720];
    memset( tmpbuf, 0, 1310720);
